...
// -----------------------------------------------------------------------------
class wphtml5_simple_html_dom_node {
...
class wphtml5_simple_html_dom {
    ...
    protected function prepare($str, $lowercase=true) {
        ...
        $this->root = new wphtml5_simple_html_dom_node($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new wphtml5_simple_html_dom_node($this);
        ++$this->cursor;
